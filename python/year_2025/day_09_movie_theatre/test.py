...
from python.year_2025.day_09_movie_theatre.solution import input_data, part_one, part_two


class TestDay09(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.example = input_data("python/year_2025/day_09_movie_theatre/example.txt")
        cls.puzzle_input = input_data("python/year_2025/day_09_movie_theatre/input.txt")

    def test_p1_example(self):
        """
        Tests Day 09 Part 1 using the example given in the scenario
        """
        self.assertEqual(part_one(self.__class__.example), 50)
        pass
    ...
    def test_p1_actual(self):
        ...
        """
        self.assertEqual(part_one(self.__class__.puzzle_input), 4781377701)
        pass
