...
class TestDay06(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.example = input_data("python/year_2025/day_06_trash_compactor/example.txt")
        cls.puzzle_input = input_data("python/year_2025/day_06_trash_compactor/input.txt")
